...
> Al presionar el boton se general una entrada y se registra en el monitor con un "1" cada vez que se presione el boton y un "0" cuando el boton este sin presionar.

![Imagen](../Img/C3.2.1.png)
