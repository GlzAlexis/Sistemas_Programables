...
<p align="center">
    <img alt="SalidaDigital" src="../_Img/C3.x_ArduinoProgramaSalidaDigital.png" width=600 height=400>
</p>

3. Explique el resultado observado.

>Se observa como el Led durando un segundo encendido y se apaga. Esto se repite cada segundo hasta que paremos el circuito.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

![Imagen](../Img/C3.1.1.png)
