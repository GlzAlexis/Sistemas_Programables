...
El codigo para el desarrollo de esta actividad fue mas largo de lo que pense. Por un momento pense que era agregar un par de lineas al codigo que se encuentra en la parte de arriba, pero no, se tiene que cambiar un poco y eliminar unas de las librerias que se usa. Ademas de imprimir todo el codigo HTML para que sea visible la pagina en el ciclo Loop del codigo.
